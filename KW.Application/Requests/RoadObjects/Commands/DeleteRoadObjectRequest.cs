...
{
    private readonly IRepository<RoadObject> _roadObjectRepo;
    ...
    public DeleteRoadObjectRequestHandler(IRepository<RoadObject> roadObjectRepo,
        IReadRepository<RoadObjectReport> reportRepo)
        => (_roadObjectRepo, _reportRepo) = (roadObjectRepo, reportRepo);
